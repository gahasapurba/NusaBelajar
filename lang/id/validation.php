...
return [
    ...
    */
    ...
    'date_equals' => 'Isian :attribute harus sama tanggalnya dengan :date.',
    ...
    'ends_with' => 'Isian :attribute harus diakhiri dengan kata-kata berikut: :values.',
    'exists' => 'Isian :attribute yang dipilih tidak tersedia.',
    'file' => 'Bidang :attribute harus berupa sebuah berkas.',
    'filled' => 'Isian :attribute harus memiliki nilai.',
    'gt' => [
        'numeric' => 'Isian :attribute harus lebih besar dari :max.',
        'file' => 'Isian :attribute harus lebih besar dari :max kilobytes.',
        'string' => 'Isian :attribute harus lebih besar dari :max karakter.',
        'array' => 'Isian :attribute harus lebih besar dari :max item.',
    ],
    'gte' => [
        'numeric' => 'Isian :attribute harus lebih besar dari atau sama dengan :max.',
        'file' => 'Isian :attribute harus lebih besar dari atau sama dengan :max kilobytes.',
        'string' => 'Isian :attribute harus lebih besar dari atau sama dengan :max karakter.',
        'array' => 'Isian :attribute harus lebih besar dari atau sama dengan :max item.',
    ],
    ...
    'lt' => [
        'numeric' => 'Isian :attribute harus lebih kecil dari :max.',
        'file' => 'Isian :attribute harus lebih kecil dari :max kilobytes.',
        'string' => 'Isian :attribute harus lebih kecil dari :max karakter.',
        'array' => 'Isian :attribute harus lebih kecil dari :max item.',
    ],
    'lte' => [
        'numeric' => 'Isian :attribute harus lebih kecil dari atau sama dengan :max.',
        'file' => 'Isian :attribute harus lebih kecil dari atau sama dengan :max kilobytes.',
        'string' => 'Isian :attribute harus lebih kecil dari atau sama dengan :max karakter.',
        'array' => 'Isian :attribute harus lebih kecil dari atau sama dengan :max item.',
    ],
    'max' => [
    ...
    'unique' => 'Isian :attribute yang anda masukkan sudah ada sebelumnya.',
    'uploaded' => 'Isian :attribute gagal diunggah.',
    'url' => 'Format isian :attribute harus berupa URL yang valid.',
    'uuid' => 'Format isian :attribute harus berupa UUID yang valid.',
