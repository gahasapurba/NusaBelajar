        ...
        <div class="col-lg-12">
            <div class="card-style mb-30">
                ...
                <p class="text-sm mb-20">
                    Berikut adalah daftar artikel yang ada di website NusaBelajar
                </p>
...
<script>
    ...
    $("body").on("click",".admin-article-destroy",function(){
        var current_object = $(this);
        event.preventDefault();
        Swal.fire({
            title: 'Apakah anda yakin ingin menghapus artikel ini?',
            text: "Apabila artikel sudah disetujui, untuk sementara, pengguna tidak akan dapat melihat artikel ini. Seluruh data terkait dengan artikel ini akan ikut terhapus sementara. Anda dapat menampilkan kembali artikel ini nantinya",
            icon: 'warning',
