    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            <div class="card-style mb-30">
                ...
                <form action="{{ route('admin.article.update', $hash->encodeHex($item->id)) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="button-group d-flex justify-content-center flex-wrap">
                                ...
                                <a href="{{ route('admin.article.index') }}" class="main-btn danger-btn-outline m-2">
                                    Batal
                                </a>
                            </div>
                        </div>
