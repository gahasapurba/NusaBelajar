...
<script>
    var datatable = $('#listAnnouncement').DataTable({
        ...
        ordering: true,
        ajax: {
            url: '{{ url('admin-announcement-list') }}',
        },
        columns: [
            {
                data: 'id',
    ...
    $("body").on("click",".admin-announcement-destroy",function(){
        var current_object = $(this);
        event.preventDefault();
        Swal.fire({
            title: 'Apakah anda yakin ingin menghapus pengumuman ini?',
            text: "Untuk sementara, pengguna tidak akan dapat melihat pengumuman ini. Anda dapat menampilkan kembali pengumuman ini nantinya",
            icon: 'warning',
