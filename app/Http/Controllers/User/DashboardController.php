...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $latest_checkouts = Checkout::where('buyer_users_id', Auth::user()->id)->latest()->limit(6)->get();
        $latest_courses = Course::where('mentor_users_id', Auth::user()->id)->latest()->limit(4)->get();
        $latest_articles = Article::where('author_users_id', Auth::user()->id)->latest()->limit(4)->get();
